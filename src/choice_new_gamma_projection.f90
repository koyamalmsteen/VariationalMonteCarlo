!
! $Id: choice_new_gamma_projection.f90,v 1.1 2004/02/15 10:52:35 k-yukino Exp $
!
#include "parameter.h"

subroutine choice_new_gamma_projection(gamma_up,gamma_down,&
idou_moto_electron_spin,idou_moto_electron,idou_saki_site,name,error)
  implicit none
...
! init
  ...
  if( GAMMA_ALGORITHM==0 ) then                ! まったくランダム
     do while( idou_moto_electron_spin==-1 )
        call choice_new_gamma_part1_projection(gamma_up,gamma_down,&
...
end subroutine choice_new_gamma_projection
