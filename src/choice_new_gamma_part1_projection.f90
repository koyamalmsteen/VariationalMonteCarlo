!
! $Id: choice_new_gamma_part1_projection.f90,v 1.1 2004/02/15 10:52:35 k-yukino Exp $
!
...
subroutine choice_new_gamma_part1_projection(gamma_up,gamma_down,&
...
end subroutine choice_new_gamma_part1_projection
