!
! $Id: choice_gamma_sigma.f90,v 1.17 2003/06/04 10:11:42 k-yukino Exp $
!
#include "parameter.h"

subroutine choice_gamma_sigma(total_sigma_electron,gamma_sigma,name,error)
...
end subroutine choice_gamma_sigma
