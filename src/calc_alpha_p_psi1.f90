...
subroutine calc_alpha_p_psi1(vector_up,vector_down,alpha_psi0,lambda,&
  ...
  real(8),intent(out) :: alpha_p_psi1
  character(32),intent(out) :: name
  integer,intent(out) :: error
  real(8),external :: calc_total_pole,jastrow
! init
  name="calc_alpha_p_psi1" ; error=0 
  alpha_p_psi1=0
  
  alpha_p_psi1=calc_total_pole(vector_up,vector_down)*alpha_psi0 &
...
end subroutine calc_alpha_p_psi1
